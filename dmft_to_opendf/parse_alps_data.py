...
def main(params):
    ...
    if (not np.all(gw_im_grids[0] == sigma_grids[0])):
        print "Grid mismatch between sigma and g"

    fgrid_in = gw_im_grids[0]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gw_real", default = "gw.dat", help = "file with the real part of gw")
    parser.add_argument("--gw_imag", default = "gw.dat", help = "file with the imag part of gw")
