...
# submit mpi jobs
submit_mpi(commands = [["date"],["touch","1.dat"],["date > 1.dat"]], add_mpirun = True, nprocs = 32, queue = "development", name="test1", cpu_time="00:01:00", use_scratch=True, pbs_file = "taskmpi.pbs", dry_run = True)
submit_mpi(commands = [["date"],["touch","1.dat"],["date > 1.dat"]], add_mpirun = True, add_mpirun_each = True, nprocs = 32, queue = "development", name="test1", cpu_time="00:01:00", use_scratch=True, pbs_file = "taskmpi2.pbs", dry_run = True)
